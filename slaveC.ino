...
Title : I2C Slave CODE 
Description : I2C Communication between Master and Slave with address 10
*/
...
void setup() 
{
  ...
  Wire.begin(10);                          //Begins I2C communication with Slave Address as 8 at pin (A4,A5)
